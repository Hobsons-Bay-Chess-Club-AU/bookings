...
export default function EventCard({ event }: EventCardProps) {
  ...
  return (
    <div className="bg-white overflow-hidden shadow-lg rounded-lg relative flex flex-col h-full transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.02] group">
      {/* QR Icon */}
      <button
        className="absolute top-1 right-1 z-20 p-1 bg-white rounded-full shadow-md hover:bg-gray-100 transition-all duration-200 hover:shadow-lg hover:scale-110"
        title="Show QR code"
      ...
      {/* QR Overlay */}
      {showQR && eventUrl && (
        <div className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-white bg-opacity-95 rounded-lg animate-fadeIn">
          <button
            className="absolute top-1 right-1 p-1 bg-gray-100 rounded-full hover:bg-gray-200 transition-all duration-200 hover:scale-110"
      ...
      {event.image_url && (
        <div className="h-48 bg-gray-200 flex-shrink-0 overflow-hidden">
          <Image
      ...
      <div className="p-6 flex flex-col flex-1">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <p className="text-sm font-medium text-indigo-600 transition-colors duration-200 group-hover:text-indigo-700">
        ...
        <div className="mt-2 flex-1">
          <h3 className="text-lg font-medium text-gray-900 transition-colors duration-200 group-hover:text-gray-800">
            {event.title}
          </h3>
          <MarkdownContent
        ...
        <div className="mt-4">
          ...
          <div className="mt-2 flex items-center justify-between">
            <p className="text-lg font-bold text-gray-900 transition-colors duration-200 group-hover:text-gray-800">
