...
export default function SocialShare({ event }: SocialShareProps) {
    ...
    const shareText = `Join me at ${event.title} on ${new Date(event.start_date).toLocaleDateString()} at ${event.location}!`
            ...
            <div className="flex flex-wrap gap-3 mb-4">
                {shareLinks.map((link) => (
                    <a
                        ...
                        className={`inline-flex items-center px-4 py-2 rounded-md text-white font-medium text-sm transition-colors ${link.color}`}
