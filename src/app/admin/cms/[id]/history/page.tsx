...
export default function ContentHistoryPage({ params }: ContentHistoryPageProps) {
    ...
    const fetchHistory = async () => {
        try {
            const response = await fetch(`/api/admin/content/${params.id}/history`)
                                ...
                                >
                                    ...
                                    <div className="text-xs text-gray-500 space-y-1">
                                        ...
                                        <p className="line-clamp-2">
                                            {truncateContent(version.body.replace(/#+\s/g, '').replace(/[*_`]/g, ''), 100)}
                                        </p>
                                    </div>
                                </div>
                            ))}
