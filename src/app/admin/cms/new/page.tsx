                            ...
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors.title ? 'border-red-300' : ''
                                            }`}
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 flex rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            className={`flex-1 block w-full border-gray-300 rounded-none rounded-r-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors.slug ? 'border-red-300' : ''
                                                }`}
                                            ...
                                            {formData.meta_keywords.map((keyword) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        ...
                                                        className="ml-2 inline-flex items-center justify-center w-4 h-4 rounded-full text-indigo-600 hover:bg-indigo-200 hover:text-indigo-800 focus:outline-none"
                                                    >
                                                        ×
                                                    </button>
                                                </span>
