...
ALTER TABLE custom_fields ADD COLUMN type VARCHAR(20) CHECK (type IN (
...
COMMENT ON COLUMN custom_fields.type IS 'Form field type including special player field types: fide_id for FIDE player search, acf_id for ACF player search';
